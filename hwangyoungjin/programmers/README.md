...
### 7/16
1. 2021 카카오 채용연계형 인턴십 - 숫자문자열과 영단어(완료)
...
1. 완전탐색 -카펫(완료)
2. 점프와순간이동(완료)
3. 2019 카카오 블라인드 - 후보키(완료) / 1번 더 풀기
### 7/10
1. 스킬트리(완료)
2. 짝지어제거하기(완료)
### 7/11
1. 구명보트(완료)
2. 2018 카카오 블라인드 - [3차]압축(완료)
### 7/12
1. 월간코드챌린지 - 이진변환반복하기(완료)
2. 2018 카카오블라인드 - [1차]캐시(완료)
### 7/13
1. 올바른괄호(완료)
2. 2018 카카오 블라인드 - [3차] 파일명 정렬(완료)
### 7/14
1. 숫자의 표현(완료)
2. 행렬의 곱셈(완료)
### 7/15
...
1. 조이스틱(완료)
### 7/25
1. 2018 카카오블라인드 - [3차] 방금그곡(완료)
2. 행렬테두리회전하기(완료)
### 7/27
1. 피보나치 수(완료)
2. JadenCase 문자열 만들기(완료)
### 7/28
1. 가장 큰 정사각형 찾기(완료)
### 7/29
1. 2017 카카오 본선 - 단체 사진찍기 (완료)
2. N개의 최소공배수 (완료)
### 8/3
1. 2020 kakao 블라인드 - 문자열압축(완료)
---
### 11/4
1. 거리두기 확인하기(finished)
### 11/5
1. 빛의 경로 사이클(finished)
  - 재귀 시간초과 -> 반복문으로 해결
